        ...
        <div className="space-y-8">
            ...
            <div className="sticky top-16 z-40">
                ...
                {hasMultipleSections && (
                    <div
                        ref={navStripRef}
                        className="no-scrollbar flex gap-2 overflow-x-auto px-4 py-2 bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur border-b border-slate-200 dark:border-slate-800"
                    >
